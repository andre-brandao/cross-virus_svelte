...
<div class=" flex justify-between gap-3 mx-3">
	{#if casos}
		<div class="flex flex-col gap-3">
			<p class="text-2xl">
				Total de casos: <span class="rounded bg-secondary text-white px-1">
					{casos}
				</span>
			</p>
		</div>
	...
	<div class="flex gap-3 mx-3">
		...
		>
			<div class="flex gap-3 justify-between">
				<div class="flex flex-col">
					...
					<input
						...
						type="text"
						bind:value={newChart.chart.data.datasets[0]
							.label}
					/>
				</div>
					...
					>
						...
						<div class="flex flex-col overflow-scroll p-2">
							...
							<ul class="flex flex-col space-y-4">
								<li>
									...
									<p class="text-gray-500">
										Filtrar por campo de texto igual a
										'TEXTO'
									</p>
								</li>
								<li>
							...
							<ul class="flex flex-col space-y-4">
								<li>
									<p>
										EXTRACT(MONTH FROM <b>CAMPO_DATA</b>) =
										7
									</p>
									<p class="text-gray-500">
										Filtrar por registros cujo mês no campo
										de data seja julho
									</p>
								</li>
							</ul>
							...
							<ul class="flex flex-col space-y-4">
								<li>
									...
									<p class="text-gray-500">
										Juntando 2 filtros com operador lógico
										AND
									</p>
								</li>
								<li>
			...
			>
				...
				<ul
					class=" flex flex-row space-x-2 overflow-scroll"
				>
